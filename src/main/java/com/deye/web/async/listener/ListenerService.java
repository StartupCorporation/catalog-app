...
public interface ListenerService {
     ...
     * So, this method causes the reservation.
     ...
     */
    void onOrderCreated(OrderCreatedMessage orderCreatedMessage);

    /**
     * When order is submitted in order microservice - catalog service should decrease reserved quantity and quantity on stock.
     *
     * @param orderSubmittedMessage
     */
    void onOrderSubmitted(OrderSubmittedMessage orderSubmittedMessage);
}
